...
if ($mform->is_cancelled()) {
    ...
    $returnurl = new moodle_url('/mod/spsupervisorapplication/view.php', array('id' => $cm->id));
    redirect($returnurl);
    ...
    $returnurl = new moodle_url('/mod/spsupervisorapplication/view_end.php', array('id' => $cm->id));
    redirect($returnurl);
} else {
